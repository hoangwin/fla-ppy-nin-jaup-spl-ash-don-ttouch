...
public class Raking : MonoBehaviour {
	...
	{
		www = new WWW("http://gamethuanviet.com/NinjaUp/SetGetData.php?type=select&username="+ ScoreControl.UserName);
		Debug.Log("http://gamethuanviet.com/NinjaUp/SetGetData.php?type=select&username=" + ScoreControl.UserName);
	...
	public void PostHightScore()
	{
		...
		string strPost = "http://gamethuanviet.com/NinjaUp/SetGetData.php?type=update&username=" + ScoreControl.UserName + "&Score=" +ScoreControl.getRealBestScore() +"&Level=0&Played=0&country=NA";
		Debug.Log(strPost);
