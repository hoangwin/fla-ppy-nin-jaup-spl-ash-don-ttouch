...
public class ScoreControl : MonoBehaviour {
	...
	public static void saveGame()
	{
        ...
        PlayerPrefs.SetInt(STRING_USER_PLAYED, mPlayed);
		PlayerPrefs.Save();
	}
	public static void loadGame()
	{
		...
		if (BestScore < 1)
						setDefaultBestScore ();
		//BestScore += OFFSET_SCORE;
        mPlayed = PlayerPrefs.GetInt(STRING_USER_PLAYED);
